...
public class MyConfig {
	...
	public static void main(String[] args){
		System.out.println(configFile.getPropertyValue("domainName"));
	}
	...
	public String getKeys(String keys) {
		...
		if (testService.equals("235")) {
			properties = configFile.LoadProperties("conf\\235Data.properties");
		}
		else if (testService.equals("236")) {
			properties = configFile.LoadProperties("conf\\236Data.properties");
		}
		else if (testService.equals("237")) {
			properties = configFile.LoadProperties("conf\\237Data.properties");
		}
		else if (testService.equals("238")) {
			properties = configFile.LoadProperties("conf\\238Data.properties");
		}
		else {
